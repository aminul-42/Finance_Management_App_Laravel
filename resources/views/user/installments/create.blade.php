                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control professional-input shadow-sm" id="payment_month" name="payment_month" required>
                                    <option value="" disabled {{ old('payment_month') ? '' : 'selected' }}>Select Month</option>
                                    @foreach (['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] as $month)
                                        <option value="{{ $month }}" {{ old('payment_month') === $month ? 'selected' : '' }}>{{ $month }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control professional-input shadow-sm" id="payment_year" name="payment_year"
                                       value="{{ old('payment_year', now()->year) }}" min="2000" max="2100" required>
                            </div>
                        </div>
                        <div class="col-md-6">
